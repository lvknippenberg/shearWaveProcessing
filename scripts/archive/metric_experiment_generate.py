...
plots blind (swp_gui/score_app.py) and we compare (scripts/archive/metric_experiment_analyze.py).
...
active round for the scorer is written to ``metric_experiment/current_round.txt``.
    ...
    <zea-python> scripts/archive/metric_experiment_generate.py --round round2 --n 100 --seed 2 [--feasible]
...
PHANTOM_25V = os.path.join(P.VOLTAGE_SWEEP, "Phantom", "DefaultPatient_SW_data_04-August-2026_13-28-32")
