...
mline.npz). Same 700 recipes as scripts/archive/sweep_extract.py (seed 0); Loupas cached per (push, IQ-config).
...
symmetry is reported but does not gate.
    ...
    <zea-python> scripts/archive/sweep_caenen.py [--push 1-52] [--n 700 --seed 0]
"""
