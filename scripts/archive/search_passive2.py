...
Usage:  python scripts/archive/search_passive2.py --window 2 --label AVC
        python scripts/archive/search_passive2.py --window 0 --label MVC
"""
...
def main():
    ...
    ap.add_argument("--folder", default=P.INVIVO_SW)
