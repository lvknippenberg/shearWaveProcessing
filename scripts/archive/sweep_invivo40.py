...
Runs the SAME 700 recipes as the phantom sweep (scripts/archive/sweep_extract.py, seed 0) on all 24 pushes of
...
Mirror-symmetry (a symmetric V about r0) is the stronger corroborator; report both.
    ...
    <zea-python> scripts/archive/sweep_invivo40.py [--meas 0-23] [--n 700 --seed 0]
"""
...
FOLDER = os.path.join(P.VOLTAGE_SWEEP, "Invivo", "Luuk40V_SW_data_04-August-2026_13-36-07")
OUTDIR = P.METRIC_EXPERIMENT
